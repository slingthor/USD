...
/// \file usdImagingMetal/renderParams.h

#ifndef USDIMAGINGMETAL_RENDERPARAMS_H
#define USDIMAGINGMETAL_RENDERPARAMS_H
...
enum class UsdImagingMetalDrawMode
{
    DRAW_POINTS,
    DRAW_WIREFRAME,
...
enum class UsdImagingMetalCullStyle
{
...
///
class UsdImagingMetalRenderParams
{
public:
    ...
    UsdTimeCode frame;
    float complexity;
    UsdImagingMetalDrawMode drawMode;
    bool showGuides;
    bool showProxy;
    bool showRender;
    bool forceRefresh;
    bool flipFrontFacing;
    UsdImagingMetalCullStyle cullStyle;
    bool enableIdRender;
    bool enableLighting;
    ...
    inline UsdImagingMetalRenderParams();

    inline bool operator==(const UsdImagingMetalRenderParams &other) const;
...
UsdImagingMetalRenderParams::UsdImagingMetalRenderParams() :
    frame(UsdTimeCode::Default()),
    complexity(1.0),
    drawMode(UsdImagingMetalDrawMode::DRAW_SHADED_SMOOTH),
    showGuides(false),
    showProxy(true),
    showRender(false),
    forceRefresh(false),
    flipFrontFacing(false),
    cullStyle(UsdImagingMetalCullStyle::CULL_STYLE_NOTHING),
...
bool 
UsdImagingMetalRenderParams::operator==(const UsdImagingMetalRenderParams &other)
    const 
{
...
#endif // USDIMAGINGMETAL_RENDERPARAMS_H
