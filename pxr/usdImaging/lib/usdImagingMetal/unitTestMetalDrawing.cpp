...
static void UsdImagingMetal_UnitTestHelper_InitPlugins()
{
...
class UsdImagingMetal_UnitTestWindow : public GarchGLDebugWindow {
public:
...
/* virtual */
void
UsdImagingMetal_UnitTestWindow::OnInitializeGL()
{
    GlfGlewInit();
...
/* virtual */
void
UsdImagingMetal_UnitTestWindow::OnPaintGL()
{
    //
...
void
UsdImagingMetal_UnitTestWindow::DrawOffscreen()
{
    _drawTarget->Bind();
...
bool
UsdImagingMetal_UnitTestWindow::WriteToFile(std::string const & attachment,
        std::string const & filename)
{
...
/* virtual */
void
UsdImagingMetal_UnitTestWindow::OnKeyRelease(int key)
{
    switch (key) {
    case 'q':
        ExitApp();
...
/* virtual */
void
UsdImagingMetal_UnitTestWindow::OnMousePress(int button,
...
/* virtual */
void
UsdImagingMetal_UnitTestWindow::OnMouseRelease(int button,
                                            int x, int y, int modKeys)
{
...
/* virtual */
void
UsdImagingMetal_UnitTestWindow::OnMouseMove(int x, int y, int modKeys)
{
...
UsdImagingMetal_UnitTestGLDrawing::RunTest(int argc, char *argv[])
{
    ...
    _widget = new UsdImagingMetal_UnitTestWindow(this, 640, 480);
    _widget->Init();
