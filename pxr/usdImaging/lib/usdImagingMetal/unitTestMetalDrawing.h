...
//
#ifndef USDIMAGINGMETAL_UNIT_TEST_METAL_DRAWING_H
#define USDIMAGINGMETAL_UNIT_TEST_METAL_DRAWING_H
...
class UsdImagingMetal_UnitTestWindow;

/// \class UsdImagingMetal_UnitTestMetalDrawing
///
/// A helper class for unit tests which need to perform Metal drawing.
///
class UsdImagingMetal_UnitTestMetalDrawing {
public:
    UsdImagingMetal_UnitTestMetalDrawing();
    virtual ~UsdImagingMetal_UnitTestMetalDrawing();
    ...
    UsdImagingMetalEngine::DrawMode GetDrawMode() const { return _drawMode; }
...
private:
    UsdImagingMetal_UnitTestWindow *_widget;
    bool _testLighting;
    bool _cameraLight;
    bool _testIdRender;
    ...
    UsdImagingMetalEngine::DrawMode _drawMode;
...
#endif // USDIMAGINGMETAL_UNIT_TEST_METAL_DRAWING_H
