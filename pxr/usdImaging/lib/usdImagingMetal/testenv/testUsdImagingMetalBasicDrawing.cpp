...
class My_TestMetalDrawing : public UsdImagingMetal_UnitTestMetalDrawing {
public:
    My_TestMetalDrawing() {
    ...
    // UsdImagingMetal_UnitTestGLDrawing overrides
...
void
My_TestMetalDrawing::InitTest()
{
    std::cout << "My_TestMetalDrawing::InitTest()\n";
    ...
    if (isEnabledHydra) {
        ...
        _engine.reset(new UsdImagingMetalHdEngine(
...
void
My_TestMetalDrawing::DrawTest(bool offscreen)
{
    std::cout << "My_TestMetalDrawing::DrawTest()\n";
...
void
My_TestMetalDrawing::ShutdownTest()
{
    std::cout << "My_TestMetalDrawing::ShutdownTest()\n";
    _engine->InvalidateBuffers();
}

void
My_TestMetalDrawing::MousePress(int button, int x, int y, int modKeys)
{
...
void
My_TestMetalDrawing::MouseRelease(int button, int x, int y, int modKeys)
{
    _mouseButton[button] = 0;
}

void
My_TestMetalDrawing::MouseMove(int x, int y, int modKeys)
{
