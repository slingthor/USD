...
//
#include "pxr/usdImaging/usdImagingMetal/hydraMaterialAdapter.h"
...
{
    typedef UsdImagingMetalHydraMaterialAdapter Adapter;
    TfType t = TfType::Define<Adapter, TfType::Bases<Adapter::BaseAdapter> >();
    t.SetFactory< UsdImagingPrimAdapterFactory<Adapter> >();
}

UsdImagingMetalHydraMaterialAdapter::~UsdImagingMetalHydraMaterialAdapter()
{
}

bool
UsdImagingMetalHydraMaterialAdapter::IsSupported(UsdImagingIndexProxy const* index) const
{
    return index->IsSprimTypeSupported(HdPrimTypeTokens->material);
}

bool
UsdImagingMetalHydraMaterialAdapter::IsPopulatedIndirectly()
{
...
SdfPath
UsdImagingMetalHydraMaterialAdapter::Populate(UsdPrim const& prim,
...
/* virtual */
void
UsdImagingMetalHydraMaterialAdapter::TrackVariability(UsdPrim const& prim,
...
TfTokenVector
UsdImagingMetalHydraMaterialAdapter::_DiscoverPrimvarsFromShaderNetwork(
...
TfTokenVector
UsdImagingMetalHydraMaterialAdapter::_DiscoverPrimvarsDeprecated(
...
TfTokenVector
UsdImagingMetalHydraMaterialAdapter::_DiscoverPrimvars(SdfPath const& shaderPath) const
{
    TfTokenVector primvars;
...
/* virtual */
void
UsdImagingMetalHydraMaterialAdapter::UpdateForTime(UsdPrim const& prim,
                                                   SdfPath const& cachePath,
                                                   UsdTimeCode time,
...
/* virtual */
HdDirtyBits
UsdImagingMetalHydraMaterialAdapter::ProcessPropertyChange(UsdPrim const& prim,
                                                           SdfPath const& cachePath,
...
/* virtual */
void
UsdImagingMetalHydraMaterialAdapter::MarkDirty(UsdPrim const& prim,
                                               SdfPath const& cachePath,
                                               HdDirtyBits dirty,
                                               UsdImagingIndexProxy* index)
{
...
/* virtual */
void
UsdImagingMetalHydraMaterialAdapter::_RemovePrim(SdfPath const& cachePath,
                                                 UsdImagingIndexProxy* index)
{
    if (IsChildPath(cachePath)) {
...
std::string
UsdImagingMetalHydraMaterialAdapter::_GetShaderSource(UsdPrim const& prim,
...
UsdImagingMetalHydraMaterialAdapter::_GetMaterialParams(UsdPrim const& prim) const
{
...
SdfPathVector
UsdImagingMetalHydraMaterialAdapter::_GetSurfaceShaderTextures(UsdPrim const &prim) const
{
...
UsdImagingMetalHydraMaterialAdapter::GetTextureResourceID(UsdPrim const& usdPrim,
                                                          SdfPath const &id,
                                                          UsdTimeCode time,
                                                          size_t salt) const
{
...
UsdImagingMetalHydraMaterialAdapter::GetTextureResource(UsdPrim const& usdPrim,
                                                        SdfPath const &id,
                                                        UsdTimeCode time) const
{
