...
//
#include "pxr/usdImaging/usdImagingMetal/drawModeAdapter.h"
...
{
    typedef UsdImagingMetalDrawModeAdapter Adapter;
    TfType t = TfType::Define<Adapter, TfType::Bases<Adapter::BaseAdapter> >();
    t.SetFactory< UsdImagingPrimAdapterFactory<Adapter> >();
}

UsdImagingMetalDrawModeAdapter::~UsdImagingMetalDrawModeAdapter()
{
}

SdfPath
UsdImagingMetalDrawModeAdapter::Populate(UsdPrim const& prim,
...
bool
UsdImagingMetalDrawModeAdapter::_IsMaterialPath(SdfPath const& path) const
{
    return IsChildPath(path) && path.GetNameToken() == _tokens->material;
}

bool
UsdImagingMetalDrawModeAdapter::_IsTexturePath(SdfPath const& path) const
{
    if (!IsChildPath(path)) {
        return false;
    }
...
void
UsdImagingMetalDrawModeAdapter::_RemovePrim(SdfPath const& cachePath,
                                         UsdImagingIndexProxy* index)
{
...
void
UsdImagingMetalDrawModeAdapter::MarkDirty(UsdPrim const& prim,
...
void
UsdImagingMetalDrawModeAdapter::MarkTransformDirty(UsdPrim const& prim,
                                                SdfPath const& cachePath,
                                                UsdImagingIndexProxy* index)
{
...
void
UsdImagingMetalDrawModeAdapter::MarkVisibilityDirty(UsdPrim const& prim,
                                                 SdfPath const& cachePath,
                                                 UsdImagingIndexProxy* index)
{
    if (!_IsMaterialPath(cachePath) && !_IsTexturePath(cachePath)) {
...
void
UsdImagingMetalDrawModeAdapter::TrackVariability(UsdPrim const& prim,
                                              SdfPath const& cachePath,
...
void
UsdImagingMetalDrawModeAdapter::UpdateForTime(UsdPrim const& prim,
                                           SdfPath const& cachePath,
                                           UsdTimeCode time,
...
HdDirtyBits
UsdImagingMetalDrawModeAdapter::ProcessPropertyChange(UsdPrim const& prim,
                                                   SdfPath const& cachePath,
...
void
UsdImagingMetalDrawModeAdapter::_GenerateOriginGeometry(
...
void
UsdImagingMetalDrawModeAdapter::_GenerateBoundsGeometry(
                                                     VtValue *topo, VtValue *points, GfRange3d const& extents) const
{
...
void
UsdImagingMetalDrawModeAdapter::_GenerateCardsCrossGeometry(
...
void
UsdImagingMetalDrawModeAdapter::_SanityCheckFaceSizes(SdfPath const& cachePath,
...
void
UsdImagingMetalDrawModeAdapter::_GenerateCardsBoxGeometry(
                                                       VtValue *topo, VtValue *points, GfRange3d const& extents,
                                                       uint8_t axes_mask) const
{
    // Bounding box: vertices are for(i: 0 -> 7) {
...
void
UsdImagingMetalDrawModeAdapter::_GenerateCardsFromTextureGeometry(
...
bool
UsdImagingMetalDrawModeAdapter::_GetMatrixFromImageMetadata(
...
void
UsdImagingMetalDrawModeAdapter::_GenerateTextureCoordinates(
...
std::string
UsdImagingMetalDrawModeAdapter::_GetSurfaceShaderSource() const
{
    boost::scoped_ptr<GLSLFX> gfx(new GLSLFX(UsdImagingMetalPackageDrawModeShader()));
    if (!gfx->IsValid()) {
...
GfRange3d
UsdImagingMetalDrawModeAdapter::_ComputeExtent(UsdPrim const& prim) const
{
    HD_TRACE_FUNCTION();
...
TfToken
UsdImagingMetalDrawModeAdapter::_GetPurpose(UsdPrim const& prim, UsdTimeCode time)
const
{
    HD_TRACE_FUNCTION();
...
UsdImagingMetalDrawModeAdapter::GetTextureResourceID(UsdPrim const& usdPrim,
                                                  SdfPath const &id,
                                                  UsdTimeCode time,
                                                  size_t salt) const
{
    return UsdImagingMetal_GetTextureResourceID(usdPrim, id, time, salt);
}

HdTextureResourceSharedPtr
UsdImagingMetalDrawModeAdapter::GetTextureResource(UsdPrim const& usdPrim,
                                                SdfPath const &id,
                                                UsdTimeCode time) const
{
    return UsdImagingMetal_GetTextureResource(usdPrim, id, time);
}
