...
UsdImagingMetalEngine::~UsdImagingMetalEngine() { /*nothing*/ }

/*virtual*/
void 
UsdImagingMetalEngine::SetCameraState(const GfMatrix4d& viewMatrix,
...
void
UsdImagingMetalEngine::SetCameraStateFromOpenGL()
{
...
/* virtual */
void
UsdImagingMetalEngine::SetLightingStateFromOpenGL()
{
    // By default, do nothing.
}
...
/* virtual */
void
UsdImagingMetalEngine::SetLightingState(GarchSimpleLightingContextPtr const &src)
{
    // By default, do nothing.
}
...
/* virtual */
void
UsdImagingMetalEngine::SetLightingState(GarchSimpleLightVector const &lights,
...
/* virtual */
void
UsdImagingMetalEngine::SetRootTransform(GfMatrix4d const& xf)
{
    // By default, do nothing.
}
...
/* virtual */
void
UsdImagingMetalEngine::SetRootVisibility(bool isVisible)
{
    // By default, do nothing.
}
...
/* virtual */
void
UsdImagingMetalEngine::SetSelected(SdfPathVector const& paths)
{
    // By default, do nothing.
}
...
/* virtual */
void
UsdImagingMetalEngine::ClearSelected()
{
    // By default, do nothing.
}
...
/* virtual */
void
UsdImagingMetalEngine::AddSelected(SdfPath const &path, int instanceIndex)
{
    // By default, do nothing.
}
...
/*virtual*/
void
UsdImagingMetalEngine::SetSelectionColor(GfVec4f const& color)
{
    // By default, do nothing.
}
...
bool
UsdImagingMetalEngine::TestIntersection(
    ...
    int *outHitElementIndex)
{
    ...
    if (!TF_VERIFY(context)) {
        TF_RUNTIME_ERROR("Invalid Metal context");
        return false;
    }
...
bool
UsdImagingMetalEngine::TestIntersectionBatch(
    const GfMatrix4d &viewMatrix,
    const GfMatrix4d &projectionMatrix,
    const GfMatrix4d &worldToLocalSpace,
...
/* virtual */
SdfPath
UsdImagingMetalEngine::GetRprimPathFromPrimId(int primId) const
{
    return SdfPath();
}
...
/* virtual */
SdfPath
UsdImagingMetalEngine::GetPrimPathFromPrimIdColor(GfVec4i const &primIdColor,
...
/* virtual */
SdfPath 
UsdImagingMetalEngine::GetPrimPathFromInstanceIndex(
...
/* virtual */
bool
UsdImagingMetalEngine::IsConverged() const
{
...
/* virtual */
TfTokenVector
UsdImagingMetalEngine::GetRendererPlugins() const
{
...
/* virtual */
bool
UsdImagingMetalEngine::SetRendererPlugin(TfToken const &id)
{
    return false;
}
