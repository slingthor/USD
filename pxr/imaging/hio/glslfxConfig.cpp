                                   ...
                                   string *errorStr) const
{
    ...
    for (const std::pair<const std::string, VtValue>& p : specDict) {
                                 ...
                                 string *errorStr) const
{
    ...
    for (const std::pair<const std::string, VtValue>& p : paramsDict) {
                               ...
                               string *errorStr) const
{
    ...
    for (const std::pair<const std::string, VtValue>& p : texturesDict) {
                                 ...
                                 string *errorStr) const
{
    ...
    for (const std::pair<const std::string, VtValue>& p : attributesDict) {
