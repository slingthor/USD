...
public:
    ...
    HDX_API
    void BindResources(HdSt_ResourceBinder const &binder, HdStProgram const &program) override;
    HDX_API
    void UnbindResources(HdSt_ResourceBinder const &binder, HdStProgram const &program) override;
    HDX_API
