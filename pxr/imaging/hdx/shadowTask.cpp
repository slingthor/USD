                    ...
                    HdDirtyBits* dirtyBits)
{
    ...
    GarchSimpleLightVector const garchLights = lightingContext->GetLights();
    ...
    for (size_t lightId = 0; lightId < garchLights.size(); ++lightId) {
        ...
        int shadowStart = garchLights[lightId].GetShadowIndexStart();
        int shadowEnd = garchLights[lightId].GetShadowIndexEnd();
