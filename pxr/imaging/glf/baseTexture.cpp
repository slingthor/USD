                            ...
                            GarchSamplerGPUHandle const& samplerName)
{
    ...
    return BindingVector(1,
                Binding(
                    identifier, GarchTextureTokens->texels,
        ...
        if (texData->IsCompressed()) {
            ...
            for (int i = 0 ; i < numMipLevels; i++) {
                _GlCompressedTexImageND(
                    numDimensions,
                    textureTarget, i,
                    GlfGetGLInternalFormat(texData->GetFormat()),
            ...
            // behaviours.
            if (HioGetComponentCount(texData->GetFormat()) == 1) {
            ...
            if (numMipLevels == 1) {
                ...
                _GlTexImageND(numDimensions,
                              ...
                              croppedDepth,
                              0,
                              GlfGetGLFormat(texData->GetFormat()),
                              GlfGetGLType(texData->GetFormat()),
