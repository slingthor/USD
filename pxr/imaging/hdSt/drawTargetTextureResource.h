...
//
#ifndef PXR_IMAGING_HD_ST_DRAW_TARGET_TEXTURE_RESOURCE_H
#define PXR_IMAGING_HD_ST_DRAW_TARGET_TEXTURE_RESOURCE_H
...
#endif // PXR_IMAGING_HD_ST_DRAW_TARGET_TEXTURE_RESOURCE_H
