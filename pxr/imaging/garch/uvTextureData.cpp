...
GarchUVTextureData::~GarchUVTextureData() = default;
...
GarchUVTextureData::_GetAllValidMipLevels(const HioImageSharedPtr fullImage) const
{
...
std::vector<HioImageSharedPtr>
GarchUVTextureData::_ReadDegradedImageInput(const HioImageSharedPtr &fullImage,
                                            bool generateMipmap,
                                            size_t targetMemory,
                                            size_t degradeLevel)
{
    ...
    for (int i = 0; i < numMipLevels; i++) {
        const size_t size =
            GarchUVTextureData_ComputeMemory(mips[i], generateMipmap);
...
{   
    ...
    WorkParallelForN(
        ...
        [this, &degradedImages, cropTop, cropBottom, cropLeft, cropRight,
         originLocation, &returnVal, flipByDefault] (size_t begin, size_t end) {
         ...
         for (size_t i = begin; i < end; ++i) {
             ...
             storage.flipped = (originLocation == HioImage::OriginLowerLeft) ? flipByDefault : !flipByDefault;
