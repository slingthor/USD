...
GarchUVTextureStorageDataRefPtr
...
GarchUVTextureStorageData::~GarchUVTextureStorageData()
{
    if (_rawBuffer) {
        delete [] _rawBuffer;
        _rawBuffer = nullptr; 
...
bool GarchUVTextureStorageData::HasRawBuffer(int mipLevel) const
{
    return (_rawBuffer != nullptr);
}

unsigned char * GarchUVTextureStorageData::GetRawBuffer(int mipLevel) const
{
    return _rawBuffer;
}
                                     ...
                                     HioImage::ImageOriginLocation originLocation)
{
    ...
    if (_storageData.IsHolding<float>()) {
        ...
        _hioFormat = HioFormatFloat32Vec3;
        ...
        _hioFormat = HioFormatFloat32Vec4;
...
int GarchUVTextureStorageData::GetNumMipLevels() const 
{
    if (_rawBuffer) return 1;
    return 0;
}

bool GarchUVTextureStorageData::IsCompressed() const {
    return false; 
}
