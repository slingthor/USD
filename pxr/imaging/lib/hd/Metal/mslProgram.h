...
//
#ifndef HD_MSL_PROGRAM_H
#define HD_MSL_PROGRAM_H
...
class HdMSLProgram: public HdProgram
{
public:
    HD_API
    HdMSLProgram(TfToken const &role);
    HD_API
    virtual ~HdMSLProgram();
...
private:
    HdResourceMetal _program;
    HdResourceMetal _uniformBuffer;
};


PXR_NAMESPACE_CLOSE_SCOPE

#endif  // HD_MSL_PROGRAM_H
