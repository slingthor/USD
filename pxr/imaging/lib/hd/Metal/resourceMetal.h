...
//
#ifndef HD_RESOURCE_METAL_H
#define HD_RESOURCE_METAL_H
...
typedef boost::shared_ptr<class HdResourceMetal> HdResourceMetalSharedPtr;

/// \class HdResourceMetal
///
/// Base class for simple Metal resource objects.
///
class HdResourceMetal : public HdResource {
public:
    HD_API
    HdResourceMetal(TfToken const & role);
    HD_API
    virtual ~HdResourceMetal();
