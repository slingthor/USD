...
HdMSLProgram::HdMSLProgram(TfToken const &role)
    : HdProgram(role), _program(role), _uniformBuffer(role)
{
}

HdMSLProgram::~HdMSLProgram()
{
...
bool
HdMSLProgram::CompileShader(GLenum type,
...
bool
HdMSLProgram::GetProgramLinkStatus(std::string * reason)
{
    return _program.GetMetalId() != nil;
}

bool
HdMSLProgram::Validate() const
{
    TF_CODING_ERROR("Not Implemented");
/*    GLuint program = _program.GetId();
