...
//
#ifndef HD_TEXTURE_RESOURCE_METAL_H
#define HD_TEXTURE_RESOURCE_METAL_H
...
class HdSimpleTextureResourceMetal : public HdTextureResource
                                   , boost::noncopyable {
public:
    HD_API
    HdSimpleTextureResourceMetal(GarchTextureHandleRefPtr const &textureHandle, bool isPtex);
    HD_API
    HdSimpleTextureResourceMetal(GarchTextureHandleRefPtr const &textureHandle, bool isPtex,
        HdWrap wrapS, HdWrap wrapT, HdMinFilter minFilter, HdMagFilter magFilter);
    HD_API
    virtual ~HdSimpleTextureResourceMetal();
...
#endif //HD_TEXTURE_RESOURCE_METAL_H
