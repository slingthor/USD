...
public:
    ...
    HD_API
    virtual void SetAllocation(HdBufferResourceGPUHandle id, size_t size);

    /// Returns the OpenGL id for this GPU resource
    virtual HdBufferResourceGPUHandle GetId() const { return (HdBufferResourceGPUHandle)(uint64_t)_id; }
