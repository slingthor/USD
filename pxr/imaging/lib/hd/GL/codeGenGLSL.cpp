...
Hd_CodeGenGLSL::Hd_CodeGenGLSL(Hd_GeometricShaderPtr const &geometricShader,
...
Hd_CodeGenGLSL::Hd_CodeGenGLSL(HdShaderCodeSharedPtrVector const &shaders)
    : _geometricShader(), _shaders(shaders)
{
}

Hd_CodeGenGLSL::ID
Hd_CodeGenGLSL::ComputeHash() const
{
    HD_TRACE_FUNCTION();
...
HdProgramSharedPtr
Hd_CodeGenGLSL::Compile()
{
    HD_TRACE_FUNCTION();
    HF_MALLOC_TAG_FUNCTION();

    // create GLSL program.
    HdProgramSharedPtr glslProgram(HdEngine::CreateProgram(HdTokens->drawingShader));
...
HdProgramSharedPtr
Hd_CodeGenGLSL::CompileComputeProgram()
{
    HD_TRACE_FUNCTION();
    HF_MALLOC_TAG_FUNCTION();
    ...
    // create GLSL program.
    HdProgramSharedPtr glslProgram(HdEngine::CreateProgram(HdTokens->computeShader));
...
void
Hd_CodeGenGLSL::_GenerateDrawingCoord()
{
...
void
Hd_CodeGenGLSL::_GenerateConstantPrimVar()
{
    /*
...
void
Hd_CodeGenGLSL::_GenerateInstancePrimVar()
{
    /*
...
void
Hd_CodeGenGLSL::_GenerateElementPrimVar()
{
    /*
...
void
Hd_CodeGenGLSL::_GenerateVertexPrimVar()
{
    /*
...
void
Hd_CodeGenGLSL::_GenerateShaderParameters()
{
    /*
      ------------- Declarations -------------
