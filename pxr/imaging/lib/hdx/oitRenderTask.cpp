...
HdxOitRenderTask::_ClearOitGpuBuffers(HdTaskContext* ctx)
{
    ...
    HdBufferArrayRangeSharedPtr stCounterBar =
        boost::dynamic_pointer_cast<HdBufferArrayRange> (_counterBar);
    ...
    // Index Buffer
    //
    HdBufferArrayRangeSharedPtr stIndexBar =
        boost::dynamic_pointer_cast<HdBufferArrayRange> (_indexBar);
    HdBufferResourceSharedPtr stIndexResource =
    ...
    // Data Buffer
    //
    HdBufferArrayRangeSharedPtr stDataBar =
        boost::dynamic_pointer_cast<HdBufferArrayRange> (_dataBar);
    HdBufferResourceSharedPtr stDataResource =
    ...
    // Depth Buffer
    //
    HdBufferArrayRangeSharedPtr stDepthBar =
        boost::dynamic_pointer_cast<HdBufferArrayRange> (_depthBar);
    HdBufferResourceSharedPtr stDepthResource =
