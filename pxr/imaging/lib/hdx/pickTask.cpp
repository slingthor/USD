...
HdxPickTask::Execute(HdTaskContext* ctx)
{
    ...
    drawTarget->GetImage("primId", &primIds[0]);
    drawTarget->GetImage("instanceId", &instanceIds[0]);
    drawTarget->GetImage("elementId", &elementIds[0]);
    drawTarget->GetImage("edgeId", &edgeIds[0]);
    drawTarget->GetImage("pointId", &pointIds[0]);
    drawTarget->GetImage("neye", &neyes[0]);
