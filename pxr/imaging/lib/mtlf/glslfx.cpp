...
MtlfGLSLFX::MtlfGLSLFX() :
    _valid(false), _hash(0)
{
    // do nothing
}

MtlfGLSLFX::MtlfGLSLFX(string const & filePath) :
...
MtlfGLSLFX::MtlfGLSLFX(istream &is) :
...
bool
MtlfGLSLFX::IsValid(std::string *reason) const
{
    if (reason && !_valid) {
...
bool
MtlfGLSLFX::_ProcessFile(string const & filePath, _ParseContext & context)
{
...
bool
MtlfGLSLFX::_ProcessInput(std::istream * input,
...
bool
MtlfGLSLFX::_ProcessImport(_ParseContext & context)
{
...
bool
MtlfGLSLFX::_ParseSectionLine(_ParseContext & context)
{
...
bool
MtlfGLSLFX::_ParseGLSLSectionLine(vector<string> const & tokens,
                                  _ParseContext & context)
{
    if (tokens.size() < 3) {
...
bool
MtlfGLSLFX::_ParseVersionLine(vector<string> const & tokens,
                              _ParseContext & context)
{
    if (context.lineNo != 1) {
...
bool
MtlfGLSLFX::_ParseConfigurationLine(_ParseContext & context)
{
...
bool
MtlfGLSLFX::_ComposeConfiguration(std::string *reason)
{
...
MtlfGLSLFX::GetParameters() const
{
    if (_config) {
...
MtlfGLSLFX::GetAttributes() const
{
    if (_config) {
...
string
MtlfGLSLFX::_GetSource(const TfToken &shaderStageKey) const
{
    if (!_config) {
        return "";
    }
...
string
MtlfGLSLFX::GetVertexSource() const
{
...
string
MtlfGLSLFX::GetTessControlSource() const
{
...
string
MtlfGLSLFX::GetTessEvalSource() const
{
...
string
MtlfGLSLFX::GetGeometrySource() const
{
...
string
MtlfGLSLFX::GetFragmentSource() const
{
    return _GetSource(_tokens->fragmentShader);
}

string
MtlfGLSLFX::GetPreambleSource() const
{
    return _GetSource(_tokens->preamble);
}

string
MtlfGLSLFX::GetSurfaceSource() const
{
    return _GetSource(_tokens->surfaceShader);
}

string
MtlfGLSLFX::GetDisplacementSource() const
{
    return _GetSource(_tokens->displacementShader);
}

string
MtlfGLSLFX::GetVertexInjectionSource() const
{
    return _GetSource(_tokens->vertexShaderInjection);
}

string
MtlfGLSLFX::GetGeometryInjectionSource() const
{
    return _GetSource(_tokens->geometryShaderInjection);
}

string
MtlfGLSLFX::GetSource(const TfToken &shaderStageKey) const
{
