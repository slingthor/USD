...
//
#ifndef MTLF_GLSLFX_H
#define MTLF_GLSLFX_H
...
///
/// a MtlfGLSLFX object is constructed by providing the path of a file whose
...
/// \endcode
///
class MtlfGLSLFX: public GLSLFX
{
public:
    ...
    MTLF_API
    MtlfGLSLFX(std::string const & filePath);

    /// Create a glslfx object from a stream
    MTLF_API
    MtlfGLSLFX(std::istream &is);
