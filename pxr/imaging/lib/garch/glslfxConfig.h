...
//
#ifndef GARCH_GLSLFX_CONFIG_H
#define GARCH_GLSLFX_CONFIG_H

/// \file garch/glslfxConfig.h
...
///
/// GLSLFXConfig provides an API for querying the configuration of a
/// glslfx file
///
class GLSLFXConfig
{
public:
    ...
    ///
    GARCH_API
    static GLSLFXConfig * Read(std::string const & input,
...
private:
    ...
    GLSLFXConfig(VtDictionary const & dict, std::string *errorStr);
