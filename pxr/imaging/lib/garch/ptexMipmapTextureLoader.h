...
//
#ifndef GARCH_PTEX_MIPMAP_TEXTURE_LOADER_H
#define GARCH_PTEX_MIPMAP_TEXTURE_LOADER_H
...
class GarchPtexMipmapTextureLoader {
public:
    GARCH_API
    GarchPtexMipmapTextureLoader(PtexTexture *ptex,
                                 int maxNumPages,
                                 int maxLevels = -1,
...
private:
    struct Block {
        ...
        void guttering(GarchPtexMipmapTextureLoader *loader, PtexTexture *ptex,
...
#endif // GARCH_PTEX_MIPMAP_TEXTURE_LOADER_H
