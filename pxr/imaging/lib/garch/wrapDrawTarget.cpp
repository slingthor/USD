...
static GarchDrawTargetRefPtr _NewDrawTarget(
    GfVec2i const & size)
{
    return GarchDrawTarget::New(size);
}

static GarchDrawTargetRefPtr _NewDrawTarget2(
    unsigned int width, unsigned int height)
{
    return GarchDrawTarget::New(GfVec2i(width, height));
}
...
void wrapDrawTarget()
{
    ...
    typedef GarchDrawTargetPtr ThisPtr;
...
TF_REFPTR_CONST_VOLATILE_GET(GarchDrawTarget)
