...
TF_DEFINE_PUBLIC_TOKENS(GarchGLSLFXTokens, GARCH_GLSLFX_TOKENS);
...
GLSLFX::GLSLFX(string const & filePath) :
...
bool
GLSLFX::IsValid(std::string *reason) const
{
    if (reason && !_valid) {
...
bool
GLSLFX::_ProcessFile(string const & filePath, _ParseContext & context)
{
...
bool
GLSLFX::_ProcessInput(std::istream * input,
                         _ParseContext & context)
{
    while (getline(*input, context.currentLine)) {
        ...
        if (context.currentSectionType == GarchGLSLFXTokens->glslfx &&
...
bool
GLSLFX::_ProcessImport(_ParseContext & context)
{
...
bool
GLSLFX::_ParseSectionLine(_ParseContext & context)
{
    ...
    if (context.currentSectionType == GarchGLSLFXTokens->glslfx.GetText()) {
...
bool
GLSLFX::_ParseGLSLSectionLine(vector<string> const & tokens,
                                  _ParseContext & context)
{
    if (tokens.size() < 3) {
...
bool
GLSLFX::_ParseVersionLine(vector<string> const & tokens,
                              _ParseContext & context)
{
    if (context.lineNo != 1) {
...
bool
GLSLFX::_ParseConfigurationLine(_ParseContext & context)
{
...
bool
GLSLFX::_ComposeConfiguration(std::string *reason)
{
...
string
GLSLFX::_GetSource(const TfToken &shaderStageKey) const
{
    if (!_config) {
        return "";
    }
...
string
GLSLFX::GetTessControlSource() const
{
...
string
GLSLFX::GetTessEvalSource() const
{
...
string
GLSLFX::GetGeometrySource() const
{
