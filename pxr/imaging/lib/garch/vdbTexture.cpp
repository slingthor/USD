...
int
GarchVdbTexture::GetNumDimensions() const
{
    return 3;
}
...
VtDictionary
GarchVdbTexture::GetTextureInfo(bool forceLoad)
{
...
bool
GarchVdbTexture::IsMinFilterSupported(GLenum filter)
{
    return true;
}

void
GarchVdbTexture::_ReadTexture()
{
    ...
    GarchBaseTextureDataRefPtr texData;
...
bool
GarchVdbTexture::_GenerateMipmap() const
{
    return true;
}

const GfBBox3d &
GarchVdbTexture::GetBoundingBox()
{
