...
void
GarchPtexMipmapTextureLoader::Block::guttering(
    GarchPtexMipmapTextureLoader *loader,
...
void
GarchPtexMipmapTextureLoader::Block::Generate(
    GarchPtexMipmapTextureLoader *loader,
    PtexTexture *ptex,
...
void
GarchPtexMipmapTextureLoader::Block::SetSize(unsigned char ulog2_,
...
struct GarchPtexMipmapTextureLoader::Page
{
    struct SlotLimit
    {
    ...
    void Generate(GarchPtexMipmapTextureLoader *loader, PtexTexture *ptex,
                  unsigned char *destination,
...
class GarchPtexMipmapTextureLoader::CornerIterator
{
public:
...
GarchPtexMipmapTextureLoader::~GarchPtexMipmapTextureLoader()
{
...
//
int
GarchPtexMipmapTextureLoader::resampleBorder(int face, int edgeId,
...
void
GarchPtexMipmapTextureLoader::sampleNeighbor(unsigned char *border, int face,
...
//
bool
GarchPtexMipmapTextureLoader::getCornerPixel(float *resultPixel, int numchannels,
                                           int face, int edge,
                                           int8_t reslog2)
{
    const Ptex::FaceInfo &fi = _ptex->getFaceInfo(face);
...
int
GarchPtexMipmapTextureLoader::getLevelDiff(int face, int edge)
{
...
void
GarchPtexMipmapTextureLoader::optimizePacking(int maxNumPages,
                                            size_t targetMemory)
{
    size_t numTexels = 0;
...
void
GarchPtexMipmapTextureLoader::generateBuffers()
{
    // ptex layout struct
    // struct Layout {
    //     uint16_t page;
