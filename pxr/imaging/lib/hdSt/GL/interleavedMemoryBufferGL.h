...
//
#ifndef HDST_INTERLEAVED_MEMORY_BUFFER_GL_H
#define HDST_INTERLEAVED_MEMORY_BUFFER_GL_H
...
/// \class HdStInterleavedMemoryBufferGL
///
/// Interleaved memory buffer for GL.
///
class HdStStripedInterleavedBufferGL : public HdStInterleavedMemoryManager::_StripedInterleavedBuffer {
public:
    /// Constructor
    HDST_API
...
#endif  // HDST_INTERLEAVED_MEMORY_BUFFER_GL_H
