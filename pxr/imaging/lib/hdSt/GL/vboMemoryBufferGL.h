...
//
#ifndef HDST_VBO_MEMORY_BUFFER_GL_H
#define HDST_VBO_MEMORY_BUFFER_GL_H
...
/// \class HdStVBOMemoryBufferGL
///
/// VBO memory buffer for GL.
///
class HdStVBOMemoryBufferGL : public HdStVBOMemoryManager::_StripedBufferArray {
public:
    /// Constructor.
    HDST_API
...
#endif  // HDST_VBO_MEMORY_BUFFER_GL_H
