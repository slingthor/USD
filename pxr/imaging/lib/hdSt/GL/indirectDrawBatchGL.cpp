...
/*virtual*/
void
HdSt_IndirectDrawBatchGL::_Init(HdStDrawItemInstance * drawItemInstance)
{
...
HdSt_IndirectDrawBatchGL::_CullingProgram &
...
void
HdSt_IndirectDrawBatchGL::_CompileBatch(
    HdStResourceRegistrySharedPtr const &resourceRegistry)
{
    HD_TRACE_FUNCTION();
...
bool
HdSt_IndirectDrawBatchGL::Validate(bool deepValidation)
{
...
void
HdSt_IndirectDrawBatchGL::_ValidateCompatibility(
...
void
HdSt_IndirectDrawBatchGL::PrepareDraw(
...
void
HdSt_IndirectDrawBatchGL::ExecuteDraw(
    HdRenderPassStateSharedPtr const &renderPassState,
    HdStResourceRegistrySharedPtr const &resourceRegistry)
{
    HD_TRACE_FUNCTION();
...
void
HdSt_IndirectDrawBatchGL::_GPUFrustumCulling(
...
void
HdSt_IndirectDrawBatchGL::_GPUFrustumCullingXFB(
    HdDrawItem const *batchItem,
    HdRenderPassStateSharedPtr const &renderPassState,
    HdStResourceRegistrySharedPtr const &resourceRegistry)
{
...
void
HdSt_IndirectDrawBatchGL::DrawItemInstanceChanged(HdStDrawItemInstance const* instance)
{
...
{
    if (!_resultBuffer) {
        _resultBuffer = boost::dynamic_pointer_cast<HdPersistentBufferGL>(
...
void
HdSt_IndirectDrawBatchGL::_CullingProgram::Initialize(
...
/* virtual */
void
HdSt_IndirectDrawBatchGL::_CullingProgram::_GetCustomBindings(
...
/* virtual */
bool
HdSt_IndirectDrawBatchGL::_CullingProgram::_Link(
