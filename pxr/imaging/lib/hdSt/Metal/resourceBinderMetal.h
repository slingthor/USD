...
//
#ifndef HDST_RESOURCE_BINDER_METAL_H
#define HDST_RESOURCE_BINDER_METAL_H
...
public:
    ...
    /// Constructor
    HDST_API
    HdSt_ResourceBinderMetal();
    
    /// Destructor
    HDST_API
    virtual ~HdSt_ResourceBinderMetal() {}
...
#endif  // HDST_RESOURCE_BINDER_METAL_H
