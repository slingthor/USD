...
//
#ifndef HDST_FIELD_RESOURCE_H
#define HDST_FIELD_RESOURCE_H
...
{
public:
    HdStFieldResource(const GarchTextureHandleRefPtr &);

    HDST_API
    ~HdStFieldResource() override;

    HDST_API HdTextureType GetTextureType() const override;
    HDST_API virtual size_t GetMemoryUsed() override;
...
private:
    ...
    const GarchTextureGPUHandle _textureId;
    const GarchSamplerGPUHandle _samplerId;
    GarchTextureGPUHandle _glTextureHandle;
