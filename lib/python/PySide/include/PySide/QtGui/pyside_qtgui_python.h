...
#define SBK_QTGUI_QLIST_QABSTRACTANIMATIONPTR_IDX                    48 // QList<QAbstractAnimation * >
#define SBK_QTGUI_QLIST_QABSTRACTSTATEPTR_IDX                        49 // const QList<QAbstractState * > &
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           50 // const QHash<int, QByteArray > &
#define SBK_QTGUI_QLIST_QGRAPHICSWIDGETPTR_IDX                       51 // QList<QGraphicsWidget * >
#define SBK_QTGUI_QLIST_QWIDGETPTR_IDX                               52 // QList<QWidget * >
