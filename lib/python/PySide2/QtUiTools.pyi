...
class QUiLoader(PySide2.QtCore.QObject):
    ...
    def createAction(self, parent: Optional[PySide2.QtCore.QObject]=..., name: str=...) -> PySide2.QtWidgets.QAction: ...
    def createActionGroup(self, parent: Optional[PySide2.QtCore.QObject]=..., name: str=...) -> PySide2.QtWidgets.QActionGroup: ...
    def createLayout(self, className: str, parent: Optional[PySide2.QtCore.QObject]=..., name: str=...) -> PySide2.QtWidgets.QLayout: ...
    def createWidget(self, className: str, parent: Optional[PySide2.QtWidgets.QWidget]=..., name: str=...) -> PySide2.QtWidgets.QWidget: ...
    def errorString(self) -> str: ...
    def isLanguageChangeEnabled(self) -> bool: ...
    def isTranslationEnabled(self) -> bool: ...
    @typing.overload
    def load(self, arg__1: str, parentWidget: Optional[PySide2.QtWidgets.QWidget]=...) -> PySide2.QtWidgets.QWidget: ...
    @typing.overload
    def load(self, device: PySide2.QtCore.QIODevice, parentWidget: Optional[PySide2.QtWidgets.QWidget]=...) -> PySide2.QtWidgets.QWidget: ...
