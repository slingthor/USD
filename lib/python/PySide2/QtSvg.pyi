...
class QGraphicsSvgItem(PySide2.QtWidgets.QGraphicsObject):
    ...
    @typing.overload
    def __init__(self, fileName: str, parentItem: Optional[PySide2.QtWidgets.QGraphicsItem]=...): ...
    @typing.overload
    def __init__(self, parentItem: Optional[PySide2.QtWidgets.QGraphicsItem]=...): ...
...
class QSvgRenderer(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, contents: PySide2.QtCore.QByteArray, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, contents: PySide2.QtCore.QXmlStreamReader, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
...
class QSvgWidget(PySide2.QtWidgets.QWidget):
    ...
    @typing.overload
    def __init__(self, file: str, parent: Optional[PySide2.QtWidgets.QWidget]=...): ...
    @typing.overload
