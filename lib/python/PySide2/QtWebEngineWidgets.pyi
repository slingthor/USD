...
class QWebEnginePage(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, profile: PySide2.QtWebEngineWidgets.QWebEngineProfile, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QWebEngineProfile(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, name: str, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, parent: Optional[PySide2.QtCore.QObject]=...): ...
