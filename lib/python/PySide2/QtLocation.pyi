...
class QGeoCodeReply(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, error: PySide2.QtLocation.QGeoCodeReply.Error, errorString: str, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
...
class QGeoCodingManagerEngine(PySide2.QtCore.QObject):
    ...
    def __init__(self, parameters: Dict, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QGeoRouteReply(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, error: PySide2.QtLocation.QGeoRouteReply.Error, errorString: str, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, request: PySide2.QtLocation.QGeoRouteRequest, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QPlaceIdReply(PySide2.QtLocation.QPlaceReply):
    ...
    def __init__(self, operationType: PySide2.QtLocation.QPlaceIdReply.OperationType, parent: Optional[PySide2.QtCore.QObject]=...): ...
