...
class QOpenGLFunctions_1_0(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glColor3b(self, red: Char, green: Char, blue: Char): ...
    def glColor3bv(self, v: Char): ...
    ...
    def glColor3ub(self, red: Char, green: Char, blue: Char): ...
    def glColor3ubv(self, v: Char): ...
    ...
    def glColor4b(self, red: Char, green: Char, blue: Char, alpha: Char): ...
    def glColor4bv(self, v: Char): ...
    ...
    def glColor4ub(self, red: Char, green: Char, blue: Char, alpha: Char): ...
    def glColor4ubv(self, v: Char): ...
    ...
    def glIsList(self, list: int) -> Char: ...
    ...
    def glNormal3b(self, nx: Char, ny: Char, nz: Char): ...
    def glNormal3bv(self, v: Char): ...
...
class QOpenGLFunctions_1_1(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glIndexs(self, c: int): ...
    def glIndexsv(self, c: int): ...
    def glIndexub(self, c: Char): ...
    def glIndexubv(self, c: Char): ...
    def glInitNames(self): ...
...
class QOpenGLFunctions_1_2(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glGetString(self, name: int) -> Char: ...
    def glHint(self, target: int, mode: int): ...
    def glHistogram(self, target: int, width: int, internalformat: int, sink: Char): ...
    def glIndexMask(self, mask: int): ...
    def glIndexPointer(self, type: int, stride: int, pointer: int): ...
    def glIndexd(self, c: float): ...
    def glIndexdv(self, c: float): ...
    ...
    def glMaterialiv(self, face: int, pname: int, params: int): ...
    def glMatrixMode(self, mode: int): ...
    def glMinmax(self, target: int, internalformat: int, sink: Char): ...
    def glMultMatrixd(self, m: float): ...
    def glMultMatrixf(self, m: float): ...
    def glNewList(self, list: int, mode: int): ...
    def glNormal3b(self, nx: Char, ny: Char, nz: Char): ...
...
class QOpenGLFunctions_1_4(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glScalef(self, x: float, y: float, z: float): ...
    def glScissor(self, x: int, y: int, width: int, height: int): ...
    def glSecondaryColor3b(self, red: Char, green: Char, blue: Char): ...
    def glSecondaryColor3bv(self, v: Char): ...
    ...
    def glSecondaryColor3ub(self, red: Char, green: Char, blue: Char): ...
    def glSecondaryColor3ubv(self, v: Char): ...
...
class QOpenGLFunctions_2_0(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glVertexAttrib4Nbv(self, index: int, v: Char): ...
    def glVertexAttrib4Niv(self, index: int, v: int): ...
    def glVertexAttrib4Nsv(self, index: int, v: int): ...
    def glVertexAttrib4Nub(self, index: int, x: Char, y: Char, z: Char, w: Char): ...
    def glVertexAttrib4Nubv(self, index: int, v: Char): ...
    def glVertexAttrib4Nuiv(self, index: int, v: int): ...
    def glVertexAttrib4Nusv(self, index: int, v: int): ...
    def glVertexAttrib4bv(self, index: int, v: Char): ...
    ...
    def glVertexAttrib4ubv(self, index: int, v: Char): ...
    def glVertexAttrib4uiv(self, index: int, v: int): ...
    def glVertexAttrib4usv(self, index: int, v: int): ...
    def glVertexAttribPointer(self, index: int, size: int, type: int, normalized: Char, stride: int, pointer: int): ...
    def glVertexPointer(self, size: int, type: int, stride: int, pointer: int): ...
    def glViewport(self, x: int, y: int, width: int, height: int): ...
    def glWindowPos2d(self, x: float, y: float): ...
    def glWindowPos2dv(self, v: float): ...
...
class QOpenGLFunctions_3_0(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glVertexAttribI4bv(self, index: int, v: Char): ...
    ...
    def glVertexAttribI4ubv(self, index: int, v: Char): ...
...
class QOpenGLFunctions_3_2_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glTexImage1D(self, target: int, level: int, internalformat: int, width: int, border: int, format: int, type: int, pixels: int): ...
    def glTexImage2D(self, target: int, level: int, internalformat: int, width: int, height: int, border: int, format: int, type: int, pixels: int): ...
    def glTexImage2DMultisample(self, target: int, samples: int, internalformat: int, width: int, height: int, fixedsamplelocations: Char): ...
    def glTexImage3D(self, target: int, level: int, internalformat: int, width: int, height: int, depth: int, border: int, format: int, type: int, pixels: int): ...
    def glTexImage3DMultisample(self, target: int, samples: int, internalformat: int, width: int, height: int, depth: int, fixedsamplelocations: Char): ...
    def glTexParameterIiv(self, target: int, pname: int, params: int): ...
    def glTexParameterIuiv(self, target: int, pname: int, params: int): ...
    def glTexParameterf(self, target: int, pname: int, param: float): ...
    def glTexParameterfv(self, target: int, pname: int, params: float): ...
...
class QOpenGLFunctions_3_3_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glVertexAttribI4usv(self, index: int, v: int): ...
    def glVertexAttribIPointer(self, index: int, size: int, type: int, stride: int, pointer: int): ...
    def glVertexAttribP1ui(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP1uiv(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP2ui(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP2uiv(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP3ui(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP3uiv(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP4ui(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribP4uiv(self, index: int, type: int, normalized: Char, value: int): ...
    def glVertexAttribPointer(self, index: int, size: int, type: int, normalized: Char, stride: int, pointer: int): ...
...
class QOpenGLFunctions_4_0_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glUniform4uiv(self, location: int, count: int, value: int): ...
    def glUniformBlockBinding(self, program: int, uniformBlockIndex: int, uniformBlockBinding: int): ...
    def glUniformMatrix2dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix2fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix2x3dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix2x3fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix2x4dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix2x4fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix3dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix3fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix3x2dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix3x2fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix3x4dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix3x4fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix4dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix4fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix4x2dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix4x2fv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix4x3dv(self, location: int, count: int, transpose: Char, value: float): ...
    def glUniformMatrix4x3fv(self, location: int, count: int, transpose: Char, value: float): ...
...
class QOpenGLFunctions_4_1_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glProgramUniformMatrix2dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix2fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix2x3dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix2x3fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix2x4dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix2x4fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix3dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix3fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix3x2dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix3x2fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix3x4dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix3x4fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix4dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix4fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix4x2dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix4x2fv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
    def glProgramUniformMatrix4x3dv(self, program: int, location: int, count: int, transpose: Char, value: float): ...
...
class QOpenGLFunctions_4_4_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glGetFragDataIndex(self, program: int, name: str) -> int: ...
    def glGetFragDataLocation(self, program: int, name: str) -> int: ...
    def glGetHistogram(self, target: int, reset: Char, format: int, type: int, values: int): ...
    def glGetMinmax(self, target: int, reset: Char, format: int, type: int, values: int): ...
    def glGetProgramResourceIndex(self, program: int, programInterface: int, name: str) -> int: ...
    def glGetProgramResourceLocation(self, program: int, programInterface: int, name: str) -> int: ...
    def glGetProgramResourceLocationIndex(self, program: int, programInterface: int, name: str) -> int: ...
...
class QOpenGLFunctions_4_5_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    ...
    def glGetnHistogram(self, target: int, reset: Char, format: int, type: int, bufSize: int, values: int): ...
    def glGetnMinmax(self, target: int, reset: Char, format: int, type: int, bufSize: int, values: int): ...
    ...
    def glTextureStorage2DMultisample(self, texture: int, samples: int, internalformat: int, width: int, height: int, fixedsamplelocations: Char): ...
    def glTextureStorage3D(self, texture: int, levels: int, internalformat: int, width: int, height: int, depth: int): ...
    def glTextureStorage3DMultisample(self, texture: int, samples: int, internalformat: int, width: int, height: int, depth: int, fixedsamplelocations: Char): ...
    ...
    def glUniformSubroutinesuiv(self, shadertype: int, count: int, indices: int): ...
    def glUnmapBuffer(self, target: int) -> Char: ...
    def glUnmapNamedBuffer(self, buffer: int) -> Char: ...
    def glUseProgram(self, program: int): ...
    def glUseProgramStages(self, pipeline: int, stages: int, program: int): ...
    def glValidateProgram(self, program: int): ...
    def glValidateProgramPipeline(self, pipeline: int): ...
    ...
    def glVertexArrayAttribFormat(self, vaobj: int, attribindex: int, size: int, type: int, normalized: Char, relativeoffset: int): ...
