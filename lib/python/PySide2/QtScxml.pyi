...
class QScxmlDynamicScxmlServiceFactory(PySide2.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, invokeInfo: PySide2.QtScxml.QScxmlExecutableContent.InvokeInfo, names: List[int], parameters: List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QScxmlStateMachine(PySide2.QtCore.QObject):
    ...
    def __init__(self, metaObject: PySide2.QtCore.QMetaObject, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QScxmlStaticScxmlServiceFactory(PySide2.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, metaObject: PySide2.QtCore.QMetaObject, invokeInfo: PySide2.QtScxml.QScxmlExecutableContent.InvokeInfo, nameList: List[int], parameters: List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: Optional[PySide2.QtCore.QObject]=...): ...
