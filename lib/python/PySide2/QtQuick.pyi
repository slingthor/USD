...
class QQuickFramebufferObject(PySide2.QtQuick.QQuickItem):
    ...
    def __init__(self, parent: Optional[PySide2.QtQuick.QQuickItem]=...): ...
...
class QQuickRenderControl(PySide2.QtCore.QObject):
    ...
    @staticmethod
    def renderWindowFor(win: PySide2.QtQuick.QQuickWindow, offset: Optional[PySide2.QtCore.QPoint]=...) -> PySide2.QtGui.QWindow: ...
    def sync(self) -> bool: ...
...
class QQuickView(PySide2.QtQuick.QQuickWindow):
    ...
    @typing.overload
    def __init__(self, source: PySide2.QtCore.QUrl, parent: Optional[PySide2.QtGui.QWindow]=...): ...
    @typing.overload
