...
class ListProperty(PySide2.QtCore.Property):
    ...
    def __init__(self, type: type, append: Callable, at: Optional[Callable]=..., clear: Optional[Callable]=..., count: Optional[Callable]=...): ...
...
class QQmlApplicationEngine(PySide2.QtQml.QQmlEngine):
    ...
    @typing.overload
    def __init__(self, filePath: str, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, url: PySide2.QtCore.QUrl, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QQmlComponent(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlEngine, fileName: str, mode: PySide2.QtQml.QQmlComponent.CompilationMode, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlEngine, fileName: str, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlEngine, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlEngine, url: PySide2.QtCore.QUrl, mode: PySide2.QtQml.QQmlComponent.CompilationMode, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlEngine, url: PySide2.QtCore.QUrl, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, parent: Optional[PySide2.QtCore.QObject]=...): ...
    ...
    @typing.overload
    def create(self, arg__1: PySide2.QtQml.QQmlIncubator, context: Optional[PySide2.QtQml.QQmlContext]=..., forContext: Optional[PySide2.QtQml.QQmlContext]=...): ...
    @typing.overload
    def create(self, context: Optional[PySide2.QtQml.QQmlContext]=...) -> PySide2.QtCore.QObject: ...
...
class QQmlContext(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, parent: PySide2.QtQml.QQmlContext, objParent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, parent: PySide2.QtQml.QQmlEngine, objParent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QQmlExpression(PySide2.QtCore.QObject):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlContext, arg__2: PySide2.QtCore.QObject, arg__3: str, arg__4: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtQml.QQmlScriptString, arg__2: Optional[PySide2.QtQml.QQmlContext]=..., arg__3: Optional[PySide2.QtCore.QObject]=..., arg__4: Optional[PySide2.QtCore.QObject]=...): ...
    ...
    def evaluate(self, valueIsUndefined: Optional[bool]=...) -> Any: ...
...
class QQmlFileSelector(PySide2.QtCore.QObject):
    ...
    def __init__(self, engine: PySide2.QtQml.QQmlEngine, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QQmlListReference(Shiboken.Object):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, arg__1: PySide2.QtCore.QObject, property: str, arg__3: Optional[PySide2.QtQml.QQmlEngine]=...): ...
    @typing.overload
