...
class QAudioInput(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, audioDeviceInfo: PySide2.QtMultimedia.QAudioDeviceInfo, format: PySide2.QtMultimedia.QAudioFormat=..., parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, format: PySide2.QtMultimedia.QAudioFormat=..., parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QCamera(PySide2.QtMultimedia.QMediaObject):
    ...
    @typing.overload
    def __init__(self, cameraInfo: PySide2.QtMultimedia.QCameraInfo, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, deviceName: PySide2.QtCore.QByteArray, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, position: PySide2.QtMultimedia.QCamera.Position, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QCameraImageCapture(PySide2.QtCore.QObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    def __init__(self, mediaObject: PySide2.QtMultimedia.QMediaObject, parent: Optional[PySide2.QtCore.QObject]=...): ...
...
class QMediaPlayer(PySide2.QtMultimedia.QMediaObject):
    ...
    def __init__(self, parent: Optional[PySide2.QtCore.QObject]=..., flags: PySide2.QtMultimedia.QMediaPlayer.Flags=...): ...
    ...
    def setMedia(self, media: PySide2.QtMultimedia.QMediaContent, stream: Optional[PySide2.QtCore.QIODevice]=...): ...
...
class QMediaPlaylist(PySide2.QtCore.QObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    @typing.overload
    def load(self, device: PySide2.QtCore.QIODevice, format: Optional[str]=...): ...
    @typing.overload
    def load(self, location: PySide2.QtCore.QUrl, format: Optional[str]=...): ...
    @typing.overload
    def load(self, request: PySide2.QtNetwork.QNetworkRequest, format: Optional[str]=...): ...
    ...
    @typing.overload
    def save(self, location: PySide2.QtCore.QUrl, format: Optional[str]=...) -> bool: ...
...
class QSoundEffect(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, audioDevice: PySide2.QtMultimedia.QAudioDeviceInfo, parent: Optional[PySide2.QtCore.QObject]=...): ...
    @typing.overload
    def __init__(self, parent: Optional[PySide2.QtCore.QObject]=...): ...
