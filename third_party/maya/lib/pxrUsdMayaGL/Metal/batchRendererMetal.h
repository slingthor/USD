...
//
#ifndef PXRUSDMAYAGL_BATCH_RENDERER_METAL_H
#define PXRUSDMAYAGL_BATCH_RENDERER_METAL_H

/// \file pxrUsdMayaGL/Metal/batchRendererMetal.h
...
///
class UsdMayaGLBatchRendererMetal
...
private:
    ...
    friend class TfSingleton<UsdMayaGLBatchRendererMetal>;
    
    PXRUSDMAYAGL_API
    UsdMayaGLBatchRendererMetal();
    
    PXRUSDMAYAGL_API
    virtual ~UsdMayaGLBatchRendererMetal();
